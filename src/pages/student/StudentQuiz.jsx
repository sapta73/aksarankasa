...
function StudentQuiz({ student, levelToPlay, gameMode, onQuizComplete }) {
  ...
  }, [timeLeft, gameMode, isAnswered, modal.isOpen]);

  const handleEndQuiz = async (finalPoints, timeUp = false) => {
